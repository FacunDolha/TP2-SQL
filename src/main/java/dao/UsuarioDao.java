...
public class UsuarioDao implements GenericDao<Usuario> {
	public Usuario findByName(String nombre) throws SQLException {
		...
		String query = "SELECT * " + "FROM usuarios "
				+ "JOIN tipo_atraccion ON tipo_atraccion.id_tipo = usuarios.preferencia" + "WHERE nombre LIKE ?";
	...
	public int insert(Usuario usuario) throws SQLException {
		String sqlQuery = "INSERT INTO usuarios (nombre,monedas,tiempo,preferencia) " + "VALUES (?,?,?,?)";
		Connection connection = ConnectionProvider.getConnection();
